    ...
    <div className="page">
      ...
      <header className="page__header">
        ...
        <p className="page__description">
          A date input is a space to enter a known date. Use it when you need a
          specific date from the user, such as a date of birth or an event date.
          The component outputs a value in{' '}
          <code>YYYY-MM-DD</code> (full) or <code>YYYY-MM</code> (compact) format.
        </p>
      </header>
